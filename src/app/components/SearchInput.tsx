...
export const SearchInput = ({
  ...
  return (
    <div
      className="relative flex items-center border-2 rounded-md w-full h-[40px] focus-within:border-primary 
    focus-within:ring-4 focus-within:ring-inputPrimary transition-all 
    lg:w-[312px]"
    >
      <svg
        width="18"
        ...
        className="absolute left-3 text-textSecondary sm:left-2 sm:w-[16px] sm:h-[16px]"
      >
        <path
      ...
      <input
        ...
        className="w-full h-full pl-10 pr-3 rounded-md outline-none bg-white text-textPrimary 
               font-inter text-base font-normal leading-[16.94px] tracking-tight sm:pl-8"
        value={searchText}
