...
export const SearchInput = ({
  ...
  return (
    <div className="relative flex items-center border-2 rounded-md w-[312px] h-[40px] focus-within:border-[#1369D9] focus-within:ring-4 focus-within:ring-[#c3d9fa] transition-all">
      <svg
        width="18"
        height="18"
        viewBox="0 0 18 18"
        ...
        className="absolute left-3 text-[#848A93]"
      >
        <path
      ...
      <input
        ...
        className="w-full h-full pl-10 pr-3 rounded-md outline-none bg-white text-[#5A5F69] font-inter text-[14px] font-normal leading-[16.94px] tracking-tight"
        value={searchText}
